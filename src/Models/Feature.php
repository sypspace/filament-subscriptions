...
namespace SYPSpace\FilamentSubscriptions\Models;
...
use Laravelcm\Subscriptions\Models\Feature as ModelsFeature;
 ...
 */
class Feature extends ModelsFeature implements Sortable
{
    use BelongsToPlan;
    use HasFactory;
    use HasSlug;
