...
namespace SYPSpace\FilamentSubscriptions\Filament\Resources;

use TomatoPHP\FilamentLocations\Models\Currency;
use SYPSpace\FilamentSubscriptions\Filament\Resources\PlanResource\Pages;
use SYPSpace\FilamentSubscriptions\Filament\Resources\PlanResource\RelationManagers;
use Filament\Forms;
                ...
                Forms\Components\Section::make()
                    ->schema([
                        ...
                        Forms\Components\Select::make('currency')
                            ->columnSpanFull()
                            ->default(config('filament-subscriptions.currency.default'))
                            ->disabled(!config('filament-subscriptions.currency.editable'))
                            ->dehydrated()
                            ->searchable()
